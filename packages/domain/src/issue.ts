...
const issueFields = new Set(Object.keys({ schema_version:1,_type:1,id:1,title:1,description:1,status:1,priority:1,issue_type:1,owner:1,assignee:1,created_by:1,created_at:1,updated_at:1,started_at:1,closed_at:1,due_at:1,defer_until:1,parent:1,labels:1,notes:1,design:1,acceptance_criteria:1,estimated_minutes:1,estimate:1,spec_id:1,external_ref:1,branch:1,metadata:1,dependencies:1,dependency_count:1,dependent_count:1,comments:1,comment_count:1 }));
