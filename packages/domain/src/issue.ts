...
const issueFields = new Set(['schema_version','_type','id','title','description','status','priority','issue_type','owner','assignee','created_by','created_at','updated_at','started_at','closed_at','due_at','defer_until','parent','labels','notes','design','acceptance_criteria','estimate','spec_id','external_ref','metadata','dependencies','dependency_count','dependent_count','comments','comment_count']);
